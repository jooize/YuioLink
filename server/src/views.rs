...
const RELEASE_DATE: &str = "2026-08-25";
...
pub fn legal_page() -> Markup {
    let body = html! {
        ...
        p.help-p {
            "These terms may change as the service does. The version of this "
            "page that is live when you create a link is the one that applies "
            "to it; the Updated date in the footer of the front page says when "
